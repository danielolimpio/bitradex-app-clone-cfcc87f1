...
const AboutUs = () => {
  ...
  const stats = [
    { value: "100+", label: "Multi Agent Self-Evolution System" },
    { value: "50K", label: "Omnidimensional Intelligent System" },
    { value: "13M", label: "Ten Million Dollar Fund Pool Increment" },
    { value: "400%", label: "Ultra-High Annualized Return Rate" },
  ];
