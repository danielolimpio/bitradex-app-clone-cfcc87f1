        ...
        <div className="mb-4 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs bg-muted px-2 py-1 rounded text-muted-foreground">Spot</span>
              </div>
          ...
          <div className="flex items-center gap-6 text-sm">
            <div>
              ...
              <div className="text-foreground font-medium">68,123.40</div>
            </div>
            <div>
              <div className="text-muted-foreground">24H Low</div>
              <div className="text-foreground font-medium">66,234.50</div>
            </div>
            <div>
              <div className="text-muted-foreground">24H Vol (BTC)</div>
              <div className="text-foreground font-medium">12,456.8934</div>
            </div>
            <div>
              <div className="text-muted-foreground">24H Vol (USDT)</div>
              <div className="text-foreground font-medium">842,567,234.12</div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-9">
            ...
            <div className="mt-4 bg-card border border-border rounded-lg p-4">
              <div className="flex items-center gap-6 border-b border-border pb-3 mb-4">
                <button className="text-foreground font-medium border-b-2 border-primary pb-1">Open Orders</button>
                <button className="text-muted-foreground hover:text-foreground transition-colors">Order History</button>
                <button className="text-muted-foreground hover:text-foreground transition-colors">Trade History</button>
                <button className="text-muted-foreground hover:text-foreground transition-colors">Funds</button>
              </div>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="bg-card border border-border rounded-lg p-4">
              ...
              <div className="border-t border-border pt-4">
                <h3 className="text-foreground font-medium mb-3 text-sm">Recent Trades</h3>
                <div className="grid grid-cols-3 gap-2 text-xs text-muted-foreground mb-2">
                  <div>Price (USDT)</div>
                  <div className="text-right">Amount (BTC)</div>
            ...
            <div className="bg-card border border-border rounded-lg p-4">
              <div className="grid grid-cols-2 gap-2 mb-4">
                <button className="bg-green-600/20 text-green-500 border border-green-600/30 py-2 rounded font-medium">
                  Buy
                </button>
                <button className="bg-muted text-muted-foreground py-2 rounded font-medium">
                  Sell
                </button>
              </div>
